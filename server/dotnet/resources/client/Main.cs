...
using Redage.SDK;
using RageSquad.Core.nAccount;
using RageSquad.Core.Character;
using RageSquad.GUI;
...
using RageSquad.Voice;
using RageSquad.Houses;
...
namespace RageSquad
{
    ...
    { 
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                Log.Write(Version + " started at " + StartDate.ToString("s"), nLog.Type.Success);
            ...
            try
            {
                ...
                if (Players.ContainsKey(player))
                {
                    ...
                    try
                    {
                        ...
                        Jobs.Drug.Event_PlayerDisconnected(player, type, reason);
            ...
            try
            {
                ...
                switch (id)
                {
                    ...
                    case 505:
                        ...
                        return;
                    case 506:
                        Jobs.Drug.StartWorkDayDrug(player);
                        return;
                    case 507:
                        Jobs.Drug.CrimePressed(player);
                        return;
                    default:
                        return;
                }
    ...
    public static class PasswordRestore
    {
        ...
        private static string mailFrom = config.TryGet<string>("From", "noreply@13squad.ru");
