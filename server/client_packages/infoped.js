...
let pedLocation = {x:-1029.5569,y:-2738.5862,z:13.836645}
...
mp.blips.new(480, new mp.Vector3(pedLocation.x, pedLocation.y, 0), {name: 'Информация', scale: 1, color: 5, shortRange: true})
